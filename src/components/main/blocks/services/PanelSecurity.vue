  ...
  <div
    ...
    <div class="lg:w-6/12 sm:w-12/12">
      ...
      <div class="prose" :class="pClass(brightness)">
        <p>
          The Internet is a (potentially) dangerous place- not just for users,
          but for websites as well. Botnets, DDoS attacks, ransomware, and other
          problems are common enough at this point that every site is
          vulnerable.
        </p>
        <p><b> Don't worry, I can help!</b></p>

        <p>My web security specialities include (but aren't limited to):</p>
        <div
          class="rounded p-2 flex items-center flex-col"
          :class="{
        ...
        <div
          ...
          <p>
            If your site has any PHP or JavaScript running (it does), there's a
            good chance coding errors, outdated libraries, or other problems are
            imperiling your site. Trust me, I've seen it all- from passwords
            saved in plain text files to packages decades out of date with 384
            critical-risk vulnerabilities... so, whatever nastiness is lurking
        ...
        <div class="prose text-center">
          ...
          <h3 class="text-xl" :class="pClass(brightness)">
            ...
            <a
              ...
              >BlenderNation Bazaar</a
            >
          </h3>
          <p class="italic opacity-50 text-sm" :class="pClass(brightness)">
            (Over 4500 a month!)
          </p>
          <p class="italic opacity-50 text-sm" :class="pClass(brightness)">
            <a href="" :class="iconClass(brightness)">Read more</a> about the
            Bazaar project
          </p>
        </div>
      </div>
