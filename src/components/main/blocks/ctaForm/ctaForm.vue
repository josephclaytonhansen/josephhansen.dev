...
<div class = "rounded p-8 flex" :class="{'bg-slate-100': brightness==5, 'bg-slate-400': brightness==4, 'bg-slate-500':brightness==3,'bg-slate-700':brightness==2, 'bg-slate-800':brightness==1}">
            <div class = "prose text-center">
                <h4 class = "text-2xl " :class = "pClass(brightness)">Piqued your interest?<br/> Check out the (incredibly simple) service pricing:</h4>
                <a href = "/pricing"><button class = "rounded px-5 py-2 text-white font-semibold mt-4" :class="{'bg-emerald-600': brightness>= 4, 'bg-orange-700': brightness == 3, 'bg-orange-600': brightness==2, 'bg-orange-500': brightness==1}">I already have a site</button></a>
                <h4 class = "text-2xl mt-8" :class = "pClass(brightness)">Looking for a new site or a custom quote? Hit me up:</h4>
                    <form>
                        ...
                        <button type="submit" class="rounded px-5 py-2 text-white font-semibold w-full mt-2" :class="{'bg-emerald-600': brightness>= 4, 'bg-slate-400': brightness == 3, 'bg-orange-600': brightness==2, 'bg-orange-500': brightness==1}">Contact Me</button>
                    </form>
            </div>
        </div>
