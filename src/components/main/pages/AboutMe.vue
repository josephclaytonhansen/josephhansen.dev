  ...
  <div class="flex-col w-full">
    <div class="p-5 flex-col w-full">
      <div class="grid grid-cols-6">
        ...
        <div class="col-span-4 sm:col-span-4 md:col-span-5 prose pl-5" style = "max-width:100vw!important;">
          ...
          <h3 class = "text-lg" :class="pClass(props.brightness)">
            ...
            <p :class="pClass(props.brightness)">
              If that section above bored you, me too. Luckily, there's a lot more to me than what I do for work. I'd call myself an artist, and that covers a lot of things I'm passionate about and love to do. I'm:</p>
              <ul :class="pClass(props.brightness)">
                <li>a 3D artist and animator</li>
                <li>a digital and traditional painter</li>
                <li>an avid cook who loves discovering new recipes and cuisines (my favorite seasoning: tamarind paste)</li>
                <li>a classically trained pianist and organist (with an infinite love for Rachmaninov, Kabalevsky, and Prokokiev)</li>
                <li>a huge nerd and massive DC fan (favorite fictional characters: Nightwing and Batgirl)</li>
              ...
              <h3 class = "text-lg" :class="pClass(props.brightness)">
                ...
                <Contact :brightness="brightness" style="margin-top:-5rem;" />
        </div>
