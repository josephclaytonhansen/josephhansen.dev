<script setup>
  ...
  const images = {
    planning: "https://images.josephhansen.dev/uploads/file2024-02-0619-1707270927524.webp",
    figma: "https://images.josephhansen.dev/uploads/file2024-02-0619-1707271001166.webp",
...
<template>
  <sliderAndGallery
    ...
    ><slot>
      ...
      <figure><img :src = "images.planning" class="rounded-xl"><figcaption>Bazaar's planning board</figcaption></figure>
      <p class="text-inherit">
        ...
        <figure><img :src = "images.figma"><figcaption>My approved design for the Bazaar</figcaption></figure>
      </p>
      <h3 class="text-2xl font-bold text-inherit">
        Tight deadlines and high stakes
      </h3>
      <p>When Bart approached me, there was about a month until the next Blender Conference, a massive community event that he hoped to present Bazaar at. At this point, the Bazaar was just an idea- there wasn't even a logo yet. Long story short- Bazaar launched successfully with time to spare. I believe this project showed  I can work well under pressure and with tight deadlines to achieve exactly what a client needs.</p>
      <h3 class="text-2xl font-bold text-inherit">
        Security- keeping the Bazaar safe
      </h3>
      <p>Among the other development, I've implemented powerful security guardrails across Bazaar, ranging from DDoS protection to a comprehensive firewall. I'm proud to report that my security measures are currently preventing around 4500 attacks a month, with that number growing larger all the time.</p>
